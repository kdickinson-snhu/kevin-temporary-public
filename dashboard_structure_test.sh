...
rg -q 'refreshed September 17, 2026' "$page"
rg -q '<div class="value">95\.5</div>' "$page"
rg -Fq '55.5 completed + 40 current' "$page"
rg -q '<div class="value">35</div>' "$page"
rg -Fq '16 completed + 19 current' "$page"
rg -q '19 distinct Jira tickets: 17 link to 19 Kevin-authored PRs' "$page"
rg -q '40 recorded points across 12 tickets' "$page"
rg -q 'MAS-1691 · 5 pts · In Review' "$page"
rg -q 'class="metric-bar kevin" style="width:100%">40<' "$page"
rg -q 'class="metric-bar kevin" style="width:100%">19<' "$page"
rg -q '>46,681<' "$page"
rg -q '<div class="value">73,769</div>' "$page"
rg -q '>Points currently recorded across active Jira scope<' "$page"
rg -q 'class="panel sprint-evidence kevin-only"' "$page"
rg -q '>Recorded points by PR author<' "$page"
rg -q 'aria-label="Recorded points legend"' "$page"
rg -q '>55\.5 \+ 40 = 95\.5<' "$page"
rg -q '>50\.5 \+ 6 = 56\.5<' "$page"
rg -q '>10\.5 \+ 8 = 18\.5<' "$page"
rg -q '>13 \+ 3 = 16<' "$page"
rg -q '>Current-sprint point segments sum recorded story points on distinct PR-linked Jira tickets' "$page"
rg -q '>28 \+ 6 = 34<' "$page"
rg -q '>17 \+ 3 = 20<' "$page"
rg -q 'class="panel quality-audit"' "$page"
rg -q '>Post-handoff quality audit<' "$page"
rg -q '>2 / 16<' "$page"
rg -q '>12.5%<.*>Affected-ticket rate<' "$page"
rg -q 'MAS-1279.*MAS-1801' "$page"
rg -q 'MAS-1480.*MAS-1841' "$page"
rg -q 'MAS-1841.*MAS-1862' "$page"
rg -q 'MAS-1855.*MAS-1884' "$page"
rg -q '>Post-QA defects<' "$page"
peer_na_count=$(rg -o 'class="matrix-cell na-cell"' "$page" | wc -l | tr -d ' ')
test "$peer_na_count" -eq 10
rg -Fq '@media(max-width:500px){.contributor-matrix{grid-template-columns:75px repeat(5,70px)' "$page"
